These notes are for the EDITORS of bspo
...
Make sure you have an ID range in the [idranges file](bspo-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [bspo-edit.owl](bspo-edit.owl)

** DO NOT EDIT bspo.obo OR bspo.owl in the top level directory **

[../../bspo.owl](../../bspo.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/obophenotype/biological-spatial-ontology) for details.
 ...
 * [bspo-idranges.owl](bspo-idranges.owl)
...
This generates derived files such as bspo.owl and bspo.obo and places
 ...
 * https://github.com/obophenotype/biological-spatial-ontology/releases
 * https://github.com/obophenotype/biological-spatial-ontology/releases/new
...
what is in the `owl:versionIRI` of the derived bspo.owl (`data-version` in
bspo.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/bspo.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/bspo/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/obophenotype/biological-spatial-ontology.svg?branch=master)](https://travis-ci.org/obophenotype/biological-spatial-ontology)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/obophenotype](https://travis-ci.org/profile/obophenotype)
 2. click the "Sync account" button
 3. Click the tick symbol next to biological-spatial-ontology
